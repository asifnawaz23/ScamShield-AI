...
const VERDICT_LINES = [
  ...
  { icon: EyeOff, title: 'What we keep and what we don\'t', body: 'We keep a short input summary (up to ~90 characters), the generated report, and metadata so you can revisit an analysis in history. We do not keep the full original message, and uploaded images are not saved as raw files. We never collect passwords, OTPs, PINs, or banking credentials — and you should never enter those anywhere.' },
